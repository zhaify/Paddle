...
function(cc_test TARGET_NAME)
  if(WITH_TESTING)
    ...
    include_directories(/home/feiyue/env/opencv3/include/opencv2)
    set(OPENCV_LIB_PATH /home/feiyue/env/opencv3/lib)
    ...
    get_property(os_dependency_modules GLOBAL PROPERTY OS_DEPENDENCY_MODULES)
    target_link_libraries(${TARGET_NAME} ${cc_test_DEPS} ${os_dependency_modules} ${OPENCV_LIBS} paddle_gtest_main lod_tensor memory gtest gflags glog)
